...
plt.ylabel('Counts')
plt.tight_layout()
plt.savefig(IMAGE_PATH/'TT_21.jpeg')
# plt.show()
...
plt.ylim(1, 1e2)
plt.tight_layout()
plt.savefig(IMAGE_PATH/'TT_21_Chn0.jpeg')
# plt.show()
...
plt.ylim(1, 1e2)
plt.tight_layout()
plt.savefig(IMAGE_PATH/'TT_21_Chn1.jpeg')
# plt.show()
...
plt.ylim(1, 1e2)
plt.tight_layout()
plt.savefig(IMAGE_PATH/'TT_21_Chn2.jpeg')
# plt.show()
...
plt.grid()
plt.tight_layout()
plt.savefig(IMAGE_PATH/'TT_21_Chn0_calib.jpeg')
# plt.show()
...
plt.grid()
plt.tight_layout()
plt.savefig(IMAGE_PATH/'TT_21_Chn1_calib.jpeg')
# plt.show()
...
plt.grid()
plt.tight_layout()
plt.savefig(IMAGE_PATH/'TT_21_Chn2_calib.jpeg')
# plt.show()
