...
Before the emission of the reaction products, the reaction leads to an intermediate state, a $\ce{^8Be}$ compound nucleus, which then rapidly decays into two alpha particles that we can detect.% An alpha particle is a helium nucleus, composed of two protons and two neutrons. %toda a gente sabe o que é uma particula alpha valhamedeus
...
\begin{equation}
\begin{split}
  E_{\alpha_{0_1}} &= 7.630 \text{ MeV} \\
  E_{\alpha_{0_2}} &= 11.031 \text{ MeV} \\
