...
For the LiF sample, we overlapped the expected $\alpha$ energy getting the following spectrum:
...
The experimental $\alpha_0$ is extremely close to the theoretical value, therefore we can confirm the presence of lithium in this sample. Analysing this spectrum further: 
...
The first one is a peak around channel 0, followed by a less intense one around 100 Chn and a small plateau between 150 and 250 Chn. 
