...
plt.ylabel('Counts')
plt.tight_layout()
plt.savefig(IMAGE_PATH/'SampleLiF.jpeg')
plt.show()
...
plt.ylabel('Counts')
plt.tight_layout()
plt.savefig(IMAGE_PATH/'SampleLiAlO2.jpeg')
plt.show()
...
plt.ylabel('Counts')
plt.tight_layout()
plt.savefig(IMAGE_PATH/'ImplantedSample.jpeg')
plt.show()
...
plt.grid()
plt.tight_layout()
plt.savefig(IMAGE_PATH/'SampleLiF_Fit.png')
plt.show()
# Print the results
...
plt.yscale('log')
plt.grid()
plt.savefig(IMAGE_PATH/'SampleLiALO2_Fit.png')
plt.show()
# Print the results
...
plt.yscale('log')
plt.grid()
plt.savefig(IMAGE_PATH/'ImplantedSample_Fit.png')
plt.show()
# Print the results
